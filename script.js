...
<section class="case-study-section"><h3>Context</h3><p>I developed Physical Control Deck during the elective Electronics and Physical Interfaces for Game Engines in Summer Semester 2026 at Darmstadt University of Applied Sciences, Faculty of Media.</p><p>The individual project explores the connection between physical electronics and interactive software: a small functional prototype that lets physical controls manipulate virtual objects in Unity in real time. The exposed breadboard supports rapid iteration rather than serving as a finished consumer enclosure.</p></section>
<section class="case-study-section"><h3>Problem</h3><p>How can physical hardware input be reliably captured, transmitted to Unity and translated into reusable virtual interaction behavior?</p><p>The challenge spans the full path from a physical action and its electrical signal to Arduino processing, serial transmission, C# interpretation and a visible response. The controls also need meaningful mappings: a directional joystick suits movement and rotation, while a rotary potentiometer suits continuous scale adjustment.</p></section>
<section class="case-study-section"><h3>Contribution</h3><p>I designed and implemented the complete physical-to-virtual prototype.</p><ul><li>Assembled the Arduino and breadboard circuit, connected and tested the joystick and potentiometer, and implemented Arduino input reading.</li><li>Established serial communication with Unity and implemented the C# input handling and interaction logic.</li><li>Implemented Move and Rotate modes, joystick-button mode switching, and independent potentiometer-controlled scaling.</li><li>Built runtime input and status feedback and tested the complete hardware-to-software interaction path.</li></ul></section>
<section class="case-study-section control-deck-implementation"><h3>Implementation</h3><div class="control-deck-chapter"><h4>Hardware Prototype</h4><p>An Arduino Uno WiFi Rev2 connects to a joystick module and potentiometer through a breadboard and jumper wires. The joystick provides two analog axes and one digital button; the potentiometer provides one continuous analog value. Keeping the wiring exposed made changes and debugging straightforward during development.</p><div class="popup-gallery popup-gallery--two control-deck-hardware"><figure><img alt="Arduino Uno WiFi Rev2 connected to the physical controller prototype." decoding="async" height="1440" loading="lazy" src="images/arduino.optimized.webp" width="1920"/><figcaption>The Arduino reads the physical inputs and passes their values to Unity.</figcaption></figure><figure><img alt="Breadboard with joystick and potentiometer used as physical input controls." decoding="async" height="1440" loading="lazy" src="images/board.optimized.webp" width="1920"/><figcaption>The joystick and potentiometer provide distinct, complementary controls.</figcaption></figure></div>
</div><div class="control-deck-chapter"><h4>Arduino-to-Unity Communication</h4><p>Physical movement begins as electrical input. Arduino reads the joystick X and Y axes, button state and potentiometer value, converts them into numerical data and sends them over the serial connection. C# inside Unity interprets those values and passes them to the interaction logic.</p><div aria-label="Physical-to-virtual signal path" class="control-deck-flow" role="list"><div class="control-deck-flow-step" role="listitem"><small>01</small><b>Physical Controls</b></div><div class="control-deck-flow-step" role="listitem"><small>02</small><b>Arduino</b></div><div class="control-deck-flow-step" role="listitem"><small>03</small><b>Serial Communication</b></div><div class="control-deck-flow-step" role="listitem"><small>04</small><b>Unity C#</b></div><div class="control-deck-flow-step" role="listitem"><small>05</small><b>Interaction Logic</b></div><div class="control-deck-flow-step" role="listitem"><small>06</small><b>Virtual Object</b></div></div>
</div><div class="control-deck-chapter"><h4>Interaction System</h4><p>The joystick is mode-dependent; the potentiometer remains dedicated to scale in either mode.</p><div class="control-deck-mappings"><article><p class="control-deck-input-label">Joystick</p><h5>Move Mode</h5><p>The joystick changes the position of the selected virtual object.</p></article><article><p class="control-deck-input-label">Joystick</p><h5>Rotate Mode</h5><p>The joystick changes the rotation of the selected virtual object.</p></article><article><p class="control-deck-input-label">Joystick button</p><h5>Mode Switching</h5><p>Pressing the joystick button switches between Move and Rotate.</p></article><article><p class="control-deck-input-label">Potentiometer</p><h5>Scale</h5><p>The potentiometer continuously controls object scale independently of the active joystick mode.</p></article></div><p class="control-deck-feedback">Runtime feedback shows the connected device, active COM port, interaction mode, selected object, joystick values, potentiometer value and current action so the physical input and virtual response can be checked together.</p></div><div aria-label="Synchronized physical-to-virtual demonstration" class="case-study-subsection control-deck-demo" data-sync-demo=""><h4>Physical-to-Virtual Demonstration</h4><p class="control-deck-demo-intro">Two synchronized views show the same interaction from the software and physical sides.</p><div class="control-deck-view"><h5 class="control-deck-view-label" id="control-deck-unity-title"><span>View 01</span> · Unity</h5><figure class="popup-media"><button aria-controls="control-deck-unity-video control-deck-physical-video" aria-label="Play synchronized demonstration" class="control-deck-surface" data-sync-toggle="" type="button"><video aria-describedby="control-deck-unity-caption" aria-labelledby="control-deck-unity-title" class="motion-media" data-managed-video="" data-poster="images/unity view.poster.webp" data-sync-video="master" disablepictureinpicture="" disableremoteplayback="" height="1080" id="control-deck-unity-video" muted="" playsinline="" preload="none" width="1920"><source data-src="images/unity view.mp4" type="video/mp4"/></video></button><figcaption id="control-deck-unity-caption">Virtual response and live input feedback inside the engine.</figcaption></figure></div><div class="control-deck-view"><h5 class="control-deck-view-label" id="control-deck-physical-title"><span>View 02</span> · Physical Controls</h5><figure class="popup-media"><button aria-controls="control-deck-unity-video control-deck-physical-video" aria-label="Play synchronized demonstration" class="control-deck-surface" data-sync-toggle="" type="button"><video aria-describedby="control-deck-physical-caption" aria-labelledby="control-deck-physical-title" class="motion-media" data-managed-video="" data-poster="images/controlling.poster.webp" data-sync-video="follower" disablepictureinpicture="" disableremoteplayback="" height="1080" id="control-deck-physical-video" muted="" playsinline="" preload="none" width="1920"><source data-src="images/controlling.optimized.mp4" type="video/mp4"/></video></button><figcaption id="control-deck-physical-caption">Joystick and potentiometer input during the same interaction.</figcaption></figure></div><div aria-label="Synchronized video controls" class="control-deck-controls" role="group"><button aria-label="Play synchronized demonstration" class="control-deck-control" data-sync-toggle="" type="button">Play</button><input aria-label="Seek synchronized demonstration" aria-valuetext="0:00 of 0:25" class="control-deck-timeline" data-sync-timeline="" max="1000" min="0" step="1" type="range" value="0"/><output aria-label="Playback time" class="control-deck-time" data-sync-time="">0:00 / 0:25</output><button aria-label="Restart both views from the beginning" class="control-deck-control" data-sync-restart="" type="button">Restart</button><button aria-label="Unmute Unity recording" class="control-deck-control" data-sync-mute="" type="button">Unmute</button><span aria-live="polite" class="sr-only" data-sync-status="" role="status"></span></div></div></section>
<section class="case-study-section control-deck-result"><h3>Result</h3><p>The working proof of concept reads multiple physical inputs, transfers them over serial communication and interprets them inside Unity. It displays live input information and supports position, rotation and scale manipulation, with the joystick button switching interaction modes.</p><figure class="popup-media"><img alt="Complete Physical Control Deck prototype with Arduino, breadboard, joystick and potentiometer." decoding="async" height="1440" loading="lazy" src="images/circuit.optimized.webp" width="1920"/><figcaption>The complete breadboard prototype connects physical controls to the Unity interaction system.</figcaption></figure><p>The result is a prototyping tool, not a finished consumer controller. Additional buttons, rotary controls, sliders or sensors are possible future extensions; they are not part of the implemented prototype.</p></section>
`,
  "ai-content-platform": `
<header class="case-study-header"><p class="case-study-kicker">VIDEOREALITY GMBH · AI PRODUCTION TOOL</p><h2 id="popup-title">Talking Paintings Production Dashboard</h2><p class="case-study-summary">A full-stack dashboard supporting the creation and preparation of AI-powered Talking Paintings characters.</p><div class="popup-meta"><span>Full-Stack AI</span><span>Human-in-the-Loop</span><span>Knowledge Systems</span><span>React + TypeScript</span><span>Python + FastAPI</span></div></header>
<section class="case-study-section project-quick-facts"><h3>Quick Facts</h3><dl class="quick-facts-grid"><div><dt>Project Type</dt><dd>Character Production Tool</dd></div><div><dt>Organisation</dt><dd>videoreality GmbH</dd></div><div><dt>Role</dt><dd>XR Project &amp; Prototyping Assistant</dd></div><div><dt>Contribution</dt><dd>Full-Stack Development · Knowledge Systems · Production Tooling</dd></div><div><dt>Frontend</dt><dd>React · TypeScript</dd></div><div><dt>Backend</dt><dd>Python · FastAPI</dd></div></dl></section>
<section class="case-study-section"><h3>Context</h3><p>Talking Paintings is the product context for this work. The dashboard supports teams creating and preparing its AI-powered characters by bringing character information, source documents, generated knowledge, review and training-data preparation into one controlled workflow.</p><p>It is a production tool within the wider product ecosystem, not the complete runtime system.</p></section>
<section class="case-study-section"><h3>Problem</h3><p>Creating an AI character requires more than one model call. Character information and source documents must be processed into usable knowledge, generated material must be reviewed and edited, and training data must be prepared and validated before downstream use.</p></section>
<section class="case-study-section"><h3>Contribution</h3><div class="contribution-grid ai-contribution-grid"><article><h4>Application &amp; API Integration</h4><p>Developed and refined React and TypeScript tooling connected to Python and FastAPI services for character-production tasks.</p></article><article><h4>Knowledge Preparation</h4><p>Worked on document processing, knowledge-base generation, retrieval-oriented preparation and controlled rebuilding.</p></article><article><h4>Validation &amp; Reliability</h4><p>Improved data handling, validation, testing and safeguards around AI-generated content.</p></article><article><h4>Production Tooling</h4><p>Contributed to tools for inspecting, editing and preparing character content before downstream use.</p></article></div></section>
<section class="case-study-section"><h3>Implementation</h3><div class="case-study-subsection"><h4>Technical Implementation</h4><div class="case-study-card-grid"><article><h5>Character Setup</h5><p>Interfaces collect and manage the information needed to define a new Talking Paintings character.</p></article><article><h5>Document Processing</h5><p>Uploaded source documents are parsed and normalized into content suitable for knowledge preparation.</p></article><article><h5>Knowledge Generation</h5><p>OpenAI API integration supports structured knowledge-base generation followed by human review and editing.</p></article><article><h5>Training-Data Preparation</h5><p>The tool prepares training examples for later model fine-tuning; it does not present this preparation step as model training.</p></article><article><h5>Validation &amp; Testing</h5><p>Data checks, operational controls and automated tests help keep content dependable before handoff.</p></article></div></div><div class="case-study-subsection"><h4>System Architecture</h4><ol aria-label="Simplified Talking Paintings character preparation flow" class="ai-system-flow"><li><span>01</span><div><strong>Source Input</strong><small>Documents and character data</small></div></li><li><span>02</span><div><strong>Document Processing</strong><small>Parse and normalize source material</small></div></li><li><span>03</span><div><strong>Structured Knowledge</strong><small>Prepare usable knowledge records</small></div></li><li><span>04</span><div><strong>AI Generation</strong><small>Generate proposed character knowledge</small></div></li><li class="ai-system-flow__feedback"><span>05</span><div><strong>Human Review</strong><small>Inspect, edit or return changes</small></div></li><li><span>06</span><div><strong>Validation</strong><small>Check structure and content quality</small></div></li><li><span>07</span><div><strong>Downstream Output</strong><small>Prepare validated content for handoff</small></div></li></ol><p class="system-flow-caption">A simplified view of the workflow. Review can return proposed changes for another generation pass.</p></div><div class="case-study-subsection"><h4>Technical Stack</h4><dl class="technical-stack-list"><div><dt>Frontend</dt><dd><span>React</span><span>TypeScript</span><span>Vite</span></dd></div><div><dt>Backend</dt><dd><span>Python</span><span>FastAPI</span><span>Pydantic</span><span>REST APIs</span></dd></div><div><dt>AI &amp; Knowledge</dt><dd><span>OpenAI API</span><span>Retrieval Preparation</span><span>Knowledge-Base Generation</span></dd></div><div><dt>Data &amp; Validation</dt><dd><span>JSON</span><span>JSON Schema</span><span>Data Models</span><span>Document Processing</span></dd></div><div><dt>Engineering</dt><dd><span>Automated Testing</span><span>Error Handling</span><span>Pipeline Integration</span></dd></div></dl></div></section>
<section class="case-study-section"><h3>Result</h3><p>The dashboard creates a clearer, more controlled path for preparing Talking Paintings characters, their knowledge and training data before downstream use.</p><p class="project-disclosure">Some implementation details and internal tooling are intentionally omitted.</p></section>
`,
  "webxr-toolkit": `
...
<figure class="popup-media popup-media--hero project-video-hero"><video controls="" data-managed-video="" data-poster="images/panel.optimized.webp" height="464" muted="" playsinline="" preload="none" width="832"><source data-src="images/webxr.mp4" type="video/mp4"/>Your browser does not support the video element.</video><figcaption>The complete browser-based workflow covers object creation, spatial manipulation, colour editing and scene persistence.</figcaption></figure>
<section class="case-study-section"><h3>Context</h3><p>The browser offered an opportunity to make simple XR blockouts more immediate and accessible before committing to a full production pipeline.</p><p><strong>WebXR Spatial Prototyping Toolkit</strong> lets users create, transform, recolour and restore spatial scenes from a desktop or headset browser. It was developed for the WebXR elective within Augmented and Virtual Reality Design (formerly known as Expanded Realities).</p></section>
<section class="case-study-section"><h3>Problem</h3><p>Early spatial ideas can lose momentum when every small change requires moving through an engine, a build and a headset test.</p><div class="case-study-goal"><p class="case-study-section-label">Project Goal</p><p class="case-study-goal-text">Explore whether browser-based spatial authoring can make early XR blockouts faster and more accessible before moving into a full Unity production pipeline.</p></div></section>
<section class="case-study-section"><h3>Contribution</h3><p>As an individual project, I designed and implemented the complete toolkit and its interaction flow.</p><div class="contribution-grid"><article><h4>Concept &amp; Experience Design</h4><p>Defined the spatial-authoring workflow around creation, selection, transformation, colour and persistence.</p></article><article><h4>WebXR Development</h4><p>Built the A-Frame scene, dynamic entity creation, raycasting and tracked-controller interactions.</p></article><article><h4>Interaction &amp; Interface Design</h4><p>Created the world-space toolbar, selection feedback, status messages and integrated help panel.</p></article><article><h4>Scene Persistence &amp; Testing</h4><p>Implemented JSON serialization, validation, reconstruction, browser storage and desktop fallback testing.</p></article></div></section>
<section class="case-study-section"><h3>Implementation</h3><div class="case-study-subsection"><h4>User Journey</h4><div class="experience-journey experience-journey--compact"><article class="experience-stage"><p class="experience-stage-number">01</p><h5>Choose a Primitive</h5><p>Select a box, sphere or cylinder from the spatial toolbar.</p><figure class="popup-media"><img alt="Controller selecting a primitive type from the WebXR spatial toolbar" decoding="async" height="446" loading="lazy" src="images/choose a primitive.gif" width="800"/><figcaption>The spatial toolbar lets the user choose a box, sphere or cylinder through controller-ray interaction.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">02</p><h5>Place It in the Scene</h5><p>Point at the floor and create the object at the raycast intersection.</p><figure class="popup-media"><img alt="Controller placing a primitive object onto the WebXR scene floor" decoding="async" height="446" loading="lazy" src="images/place object.gif" width="800"/><figcaption>The selected primitive is created directly at the controller ray’s intersection with the floor.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">03</p><h5>Select an Object</h5><p>Point at a created object to select it and reveal the yellow selection marker.</p><figure class="popup-media"><img alt="Selected primitive objects arranged in the WebXR scene" decoding="async" height="1080" loading="lazy" src="images/spawned and manipulated objects.optimized.webp" width="1920"/><figcaption>The selection marker and arranged primitives make the current scene state immediately visible.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">04</p><h5>Transform the Object</h5><p>Move, rotate or uniformly scale the selected object through desktop or controller input.</p><figure class="popup-media"><img alt="Controller grabbing, rotating and scaling an object in the WebXR toolkit" decoding="async" height="446" loading="lazy" src="images/transform object.gif" width="800"/><figcaption>Grab, rotate and scale modes support direct spatial editing of the selected object.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">05</p><h5>Change Its Colour</h5><p>Apply one of three colour presets to distinguish objects in the blockout.</p><figure class="popup-media"><img alt="Controller changing the colour of a selected WebXR object" decoding="async" height="446" loading="lazy" src="images/change color.gif" width="800"/><figcaption>Colour presets provide immediate visual differentiation while building a simple spatial blockout.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">06</p><h5>Save and Restore the Scene</h5><p>Save the object data locally, clear the visible scene and reconstruct the saved state.</p><figure class="popup-media"><img alt="WebXR scene being saved, cleared and restored from browser storage" decoding="async" height="446" loading="lazy" src="images/save and reload.gif" width="800"/><figcaption>The scene is saved to browser storage, cleared and reconstructed from its serialized object data.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">07</p><h5>Access Help</h5><p>Open the in-scene guide to review desktop and controller interactions.</p><figure class="popup-media"><img alt="WebXR spatial help panel showing desktop and controller controls" decoding="async" height="1080" loading="lazy" src="images/help panel.optimized.webp" width="1920"/><figcaption>The spatial help panel explains creation, transformation, persistence and platform-specific controls.</figcaption></figure></article></div></div><div class="case-study-subsection"><h4>Design Decisions</h4><div class="case-study-card-grid"><article><h5>Browser Before Native Build</h5><p>A static web experience reduces the setup needed for testing early spatial ideas before committing them to a Unity project.</p></article><article><h5>A-Frame for Rapid Prototyping</h5><p>Declarative scene entities and built-in XR abstractions made it possible to focus on authoring interactions rather than low-level rendering setup.</p></article><article><h5>Spatial Interface with Desktop Fallback</h5><p>The same world-space toolbar supports controller-ray interaction in XR and mouse interaction during desktop development.</p></article><article><h5>Lightweight Local Persistence</h5><p>LocalStorage preserves a scene without requiring accounts, a backend service or a custom file format.</p></article></div></div><div class="case-study-subsection"><h4>Technical Implementation</h4><div class="case-study-card-grid"><article><h5>Dynamic Object Factory</h5><p>A shared <code>createObject()</code> function creates boxes, spheres and cylinders and restores saved entities through the same implementation path.</p></article><article><h5>Raycast Placement and Selection</h5><p>A-Frame raycasters target the placement floor and dynamically created <code>.clickable</code> entities for object creation and selection.</p></article><article><h5>Desktop and Controller Input</h5><p>Keyboard controls, controller rays, grip events and thumbstick input converge on shared movement, rotation and scaling functions.</p></article><article><h5>Controller-Relative Grabbing</h5><p>A custom A-Frame component preserves the object’s grab offset and converts controller world coordinates back into local scene coordinates.</p></article><article><h5>Scene Serialization</h5><p>Object type, position, rotation, scale and colour are converted to JSON, validated and reconstructed from browser LocalStorage.</p></article></div></div><div class="case-study-subsection"><h4>Process</h4><div class="case-study-card-grid"><article><h5>Authoring Flow</h5><p>Choose primitive → place → select → transform → recolour → save → reset → load</p></article><article><h5>Persistence Flow</h5><p>A-Frame entity → serializable scene data → JSON → LocalStorage → validated reconstruction</p></article></div></div></section>
<section class="case-study-section"><h3>Result</h3><p>The completed browser-based toolkit connects object creation, selection, transformation, feedback and persistence in one coherent spatial-authoring flow.</p><p>It demonstrates how early spatial prototypes can be tested directly in a browser before moving to a heavier Unity build and headset pipeline.</p></section>
...
<section class="case-study-section"><h3>Implementation</h3><div class="case-study-subsection"><h4>User Journey</h4><div class="experience-journey"><article class="experience-stage"><p class="experience-stage-number">01</p><h5>Arrive</h5><p>Begin at the forest edge and enter the first playable area.</p><figure class="popup-media"><img alt="Player arriving at the forest-edge spawn point" decoding="async" height="788" loading="lazy" src="images/spawn point.png" width="1400"/><figcaption>The opening viewpoint establishes the player, camera and first route through the environment.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">02</p><h5>Explore the Village</h5><p>Navigate connected paths, buildings and landmarks.</p><figure class="popup-media"><img alt="Wide view across the lake village" decoding="async" height="807" loading="lazy" src="images/lake village.optimized.webp" width="1434"/><figcaption>The broad layout supports exploration while visible landmarks preserve orientation.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">03</p><h5>Meet NPCs</h5><p>Interact with characters who provide context and direction.</p><figure class="popup-media"><img alt="Player meeting Miku inside a village building" decoding="async" height="796" loading="lazy" src="images/miku.png" width="796"/><figcaption>NPC encounters break up exploration and give the journey a more personal focus.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">04</p><h5>Collect Resources</h5><p>Find health items placed throughout the environment.</p><figure class="popup-media"><img alt="Glowing health potion collectible" decoding="async" height="761" loading="lazy" src="images/heal potion.png" width="1353"/><figcaption>The bright collectible silhouette remains readable inside the dark environment.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">05</p><h5>Fight Enemy Guards</h5><p>Use a three-stage melee combo against patrolling enemies.</p><figure class="popup-media"><img alt="Third-person player facing an enemy guard" decoding="async" height="840" loading="lazy" src="images/player view.optimized.webp" width="1507"/><figcaption>The camera keeps the character, enemy and surrounding combat space visible.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">06</p><h5>Reach the Emperor’s Village</h5><p>Progress through connected scenes toward the final area.</p><figure class="popup-media"><img alt="Elevated route through the emperor village" decoding="async" height="796" loading="lazy" src="images/emperor village2.optimized.webp" width="1416"/><figcaption>The elevated route and denser architecture make progression toward the finale visually clear.</figcaption></figure></article></div></div><div class="case-study-subsection"><h4>Design Decisions</h4><div class="case-study-card-grid"><article><h5>Readable Combat</h5><p>A three-stage melee combo and clear enemy silhouette make attack timing and encounter distance easier to read.</p><figure class="popup-media"><img alt="Enemy guard in an active combat stance" decoding="async" height="787" loading="lazy" src="images/guard.png" width="787"/><figcaption>The guard’s stance and health feedback communicate an active combat state at a glance.</figcaption></figure></article><article><h5>Environmental Storytelling</h5><p>Architecture, lighting and placed props suggest a lived-in settlement without interrupting play with exposition.</p><figure class="popup-media"><img alt="Detailed architecture and props in the first village" decoding="async" height="805" loading="lazy" src="images/first village4.optimized.webp" width="1432"/><figcaption>Small environmental details make the village feel inhabited rather than purely functional.</figcaption></figure></article><article><h5>Progression Through Space</h5><p>Paths, stairs and gateways frame the next destination and guide the player between encounters.</p><figure class="popup-media"><img alt="Stairs and framed route through the first village" decoding="async" height="808" loading="lazy" src="images/first village3.optimized.webp" width="1436"/><figcaption>The route uses elevation and framing to pull attention toward the next objective.</figcaption></figure></article></div></div><div class="case-study-subsection"><h4>Technical Implementation</h4><div class="case-study-card-grid"><article><h5>Player &amp; Combat</h5><p>A third-person controller, Animator states and trigger-based hit detection support movement and the three-stage melee combo.</p></article><article><h5>Enemy Behaviour</h5><p>NavMesh agents move through idle, patrol, chase, attack, damage and death states.</p></article><article><h5>Pickups &amp; Events</h5><p>Scriptable Objects and Unity Events connect health pickups with gameplay, UI and audio feedback.</p><figure class="popup-media"><img alt="Health potion placed beside an optional village route" decoding="async" height="792" loading="lazy" src="images/heal potion2.optimized.webp" width="1408"/><figcaption>World placement turns recovery into a reward for exploring optional spaces.</figcaption></figure></article><article><h5>Scene Progression</h5><p>Shared state and scene transitions preserve progression across three connected locations.</p><figure class="popup-media"><img alt="Dense final settlement in the emperor village" decoding="async" height="805" loading="lazy" src="images/emperor village.optimized.webp" width="1430"/><figcaption>The final settlement adds density while retaining the game’s established visual language.</figcaption></figure></article><article><h5>Level Structure</h5><p>Landmarks, route width and environmental framing support navigation through the larger playable spaces.</p><figure class="popup-media"><img alt="Landmarks and branching routes in the lake village" decoding="async" height="780" loading="lazy" src="images/lake village2.optimized.webp" width="1386"/><figcaption>Distinct structures help the player recognise routes and important areas from a distance.</figcaption></figure></article></div></div><div class="case-study-subsection"><h4>Process &amp; Gallery</h4><h5>Environment Composition</h5><div class="popup-gallery popup-gallery--two"><figure><img alt="Layered buildings along the main village route" decoding="async" height="792" loading="lazy" src="images/first village2.optimized.webp" width="1408"/><figcaption>Layered architecture creates visual depth across the main village route.</figcaption></figure><figure><img alt="Vegetation and foreground structures framing a village path" decoding="async" height="798" loading="lazy" src="images/first village5.optimized.webp" width="1419"/><figcaption>Foreground structures and vegetation frame the playable space without blocking navigation.</figcaption></figure></div><h5>World Building</h5><div class="popup-gallery popup-gallery--single"><figure><img alt="Wide overview of the first village and forest boundary" decoding="async" height="817" loading="lazy" src="images/first village.optimized.webp" width="1452"/><figcaption>The wide view shows how buildings, paths and forest boundaries combine into one explorable environment.</figcaption></figure></div><h5>Narrative &amp; Interface</h5><div class="popup-gallery popup-gallery--two"><figure><img alt="Opening story screen describing the player mission" decoding="async" height="845" loading="lazy" src="images/story screen.optimized.webp" width="1502"/><figcaption>The story screen introduces the occupation, mission and final objective before gameplay begins.</figcaption></figure><figure><img alt="Blade of the Dawn main menu" decoding="async" height="841" loading="lazy" src="images/main menu.optimized.webp" width="1495"/><figcaption>The main menu establishes the game’s visual tone before the player enters the world.</figcaption></figure></div><h5>Character Presentation</h5><div class="popup-gallery popup-gallery--single"><figure><img alt="Miku staged inside an authored interaction space" decoding="async" height="813" loading="lazy" src="images/miku2.optimized.webp" width="813"/><figcaption>The indoor view shows how the NPC is staged within an authored interaction space.</figcaption></figure></div></div></section>
<section class="case-study-section"><h3>Result</h3><p>The result is a complete playable game connecting player control, combat, enemy states, events, interface and progression across three scenes.</p></section>
<section class="case-study-section project-links-section"><h3>Project Links</h3><div class="project-video-block"><h4>Full Gameplay Walkthrough</h4><div class="video-container"><iframe allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen="" loading="lazy" src="https://www.youtube-nocookie.com/embed/eEEXLtWiqOk" title="Blade of the Dawn full gameplay walkthrough"></iframe></div></div><div class="project-external-links"><a class="project-external-link" href="https://github.com/antonelamatanovich/Blade-Of-The-Dawn" rel="noopener" target="_blank"><span>View GitHub Repository</span><span aria-hidden="true">↗</span></a></div></section>
`,  "retro-snake": `
...
<figure class="popup-media popup-media--hero"><img alt="Retro Snake gameplay showing movement, collection and score" class="project-hero-image project-hero-image--contain" decoding="async" height="628" loading="lazy" src="images/retro snake.gif" width="800"/><figcaption>The loop combines movement, collection, growth, scoring and collision.</figcaption></figure>
<section class="case-study-section"><h3>Context</h3><p>The clarity of Snake made it possible to focus on how input, state, feedback and replay work together.</p><p><strong>Retro Snake</strong> combines the classic arcade loop with onboarding, menus and a monochrome pixel-art presentation. The project established a practical foundation for my later work in Unity and XR.</p></section>
<section class="case-study-section"><h3>Problem</h3><p>My first programming challenge was not simply to make a character move, but to turn a familiar rule set into a complete and reliable application loop.</p><div class="case-study-goal"><p class="case-study-section-label">Project Goal</p><p class="case-study-goal-text">Recreate the classic Snake loop while learning the core programming structures behind a complete interactive application.</p></div></section>
<section class="case-study-section"><h3>Contribution</h3><p>As an individual project, I designed and implemented the complete game, interface and application flow.</p><div class="contribution-grid"><article><h4>Game Design</h4><p>Designed the rules and flow.</p></article><article><h4>Programming</h4><p>Built movement, growth, food, collisions and scoring.</p></article><article><h4>Interface &amp; State Flow</h4><p>Created menus, guidance and replay states.</p></article><article><h4>Testing &amp; Refinement</h4><p>Tested gameplay and reset behaviour.</p></article></div></section>
<section class="case-study-section"><h3>Implementation</h3><div class="case-study-subsection"><h4>User Journey</h4><div class="experience-journey experience-journey--compact"><article class="experience-stage"><p class="experience-stage-number">01</p><h5>Start the Game</h5><p>Choose Play, Controls or Rules.</p><figure class="popup-media"><img alt="Retro Snake menu" decoding="async" height="971" loading="lazy" src="images/start screen.png" width="971"/><figcaption>The menu introduces the application flow.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">02</p><h5>Move Across the Grid</h5><p>Use four-direction arrow input.</p><figure class="popup-media"><img alt="Retro Snake controls" decoding="async" height="973" loading="lazy" src="images/help screen.png" width="973"/><figcaption>The controls explain movement.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">03</p><h5>Collect Food</h5><p>Reach grid-aligned food.</p><figure class="popup-media"><img alt="Retro Snake collecting food" decoding="async" height="628" loading="lazy" src="images/retro snake.gif" width="800"/><figcaption>The live grid makes the core loop immediate.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">04</p><h5>Avoid Collisions</h5><p>Walls or the body end the run.</p><figure class="popup-media"><img alt="Retro Snake rules" decoding="async" height="969" loading="lazy" src="images/rules screen.png" width="976"/><figcaption>The rules clarify loss conditions.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">05</p><h5>Replay</h5><p>Retry or return to the menu.</p><figure class="popup-media"><img alt="Retro Snake game over" decoding="async" height="987" loading="lazy" src="images/game over.png" width="1243"/><figcaption>The final state offers retry and back navigation.</figcaption></figure></article></div></div><div class="case-study-subsection"><h4>Design Decisions</h4><div class="case-study-card-grid"><article><h5>Grid-Based Movement</h5><p>Fixed steps preserve classic Snake rhythm.</p></article><article><h5>Guided Onboarding</h5><p>Controls and rules prepare new players.</p></article><article><h5>Reliable Replay</h5><p>All gameplay values reset together.</p></article></div></div><div class="case-study-subsection"><h4>Technical Implementation</h4><div class="case-study-card-grid"><article><h5>Game Loop</h5><p>Processing handles input, updates and rendering.</p></article><article><h5>Grid Movement</h5><p>Fixed steps prevent reversal.</p></article><article><h5>Body Representation</h5><p>Coordinate arrays support following and growth.</p></article><article><h5>Collision &amp; Scoring</h5><p>Checks control pickups, score and game over.</p></article><article><h5>State Management</h5><p>One variable connects five states.</p></article><article><h5>Replay</h5><p>Reset logic restores gameplay data.</p></article></div></div></section>
<section class="case-study-section"><h3>Result</h3><p>The finished application combines movement, arrays, collision detection, menus and predictable reset logic into a complete game loop.</p><p class="project-attribution">Third-party visual assets and fonts were integrated without claiming authorship.</p></section>
...
<figure class="popup-media popup-media--hero project-video-hero"><video aria-label="Discovering Barite project trailer" autoplay="" data-managed-video="" height="720" loop="" muted="" playsinline="" preload="none" width="1280"><source data-src="images/Discovering Barite.mp4" type="video/mp4"/>Your browser does not support the video element.</video><figcaption>On-site Augmented Reality reveals hidden geological structures.</figcaption></figure>
<section class="case-study-section"><h3>Context</h3><p>The site created an opportunity to use a familiar device as a window into processes that are normally invisible.</p><p><strong>Discovering Barite</strong> guides visitors through short questions before revealing the barite-bearing structure within a reconstructed rock face. Image tracking anchors the experience directly to the existing information board, keeping the digital story connected to the place.</p></section>
<section class="case-study-section"><h3>Problem</h3><p>Visitors could walk through the Spatschlucht without ever seeing the geological and mining history hidden beneath the rock.</p><div class="case-study-goal"><p class="case-study-section-label">Project Goal</p><p class="case-study-goal-text">Help visitors understand hidden geological structures through a short, dependable on-site mobile Augmented Reality journey.</p></div></section>
<section class="case-study-section"><h3>Contribution</h3><div class="contribution-grid"><article><h4>UI &amp; Interaction Design</h4><p>Designed the question interface and flow.</p></article><article><h4>Development &amp; Integration</h4><p>Connected events, states and questions.</p></article><article><h4>Tracking &amp; Testing</h4><p>Developed and tested Vuforia anchoring.</p></article><article><h4>Experience Design</h4><p>Helped evolve the concept and storyboard.</p></article><article><h4>Project Coordination</h4><p>Supported planning and reviews.</p></article></div><div class="collaboration-credits case-study-subsection"><h4>Collaboration &amp; Credits</h4><div class="credit-list"><p class="credit-list__item">Antonela Matanović · Jacopo Perilli · Karam Al Sawaftah</p></div></div></section>
<section class="case-study-section"><h3>Implementation</h3><div class="case-study-subsection"><h4>User Journey</h4><div class="experience-journey"><article class="experience-stage"><p class="experience-stage-number">01</p><h5>Introduction</h5><p>Learn why barite matters at the Spatschlucht and what the experience will reveal.</p><figure class="popup-media"><img alt="Location of the Discovering Barite experience at the Spatschlucht" decoding="async" height="1080" loading="lazy" src="images/location.optimized.webp" width="1920"/><figcaption>The introduction situates the experience within the Spatschlucht before the on-site interaction begins.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">02</p><h5>Scan the Marker</h5><p>Point the phone at the selected reference on the existing information board to establish a local Augmented Reality anchor.</p><figure class="popup-media"><video aria-label="Spatschlucht information board used as the Discovering Barite image target" autoplay="" class="motion-media" data-managed-video="" data-motion-key="scanning the marker" data-poster="images/scanning the marker.poster.webp" height="450" loop="" muted="" playsinline="" preload="none" width="800"><source data-src="images/scanning the marker.loop.webm" type="video/webm"/><source data-src="images/scanning the marker.loop.mp4" type="video/mp4"/></video><figcaption>The existing sign provides a recognisable and repeatable reference for positioning the virtual geology.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">03</p><h5>Answer the Questions</h5><p>Follow three short prompts that direct attention towards geological formation, erosion and traces of mining.</p><figure class="popup-media experience-stage-media--portrait"><video aria-label="Visitor answering geological questions inside the Discovering Barite mobile Augmented Reality experience" autoplay="" class="motion-media" data-managed-video="" data-motion-key="answering questions" data-poster="images/answering questions.poster.webp" height="720" loop="" muted="" playsinline="" preload="none" width="1280"><source data-src="images/answering questions.loop.webm" type="video/webm"/><source data-src="images/answering questions.loop.mp4" type="video/mp4"/></video><figcaption>The guided questions focus attention on the site before the final geological reveal.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">04</p><h5>Reveal the Barite</h5><p>Move through the reconstructed rock face to reveal the barite-bearing structure hidden inside.</p><figure class="popup-media experience-stage-media--portrait"><video aria-label="Mobile slider slicing through a reconstructed rock face to reveal the barite layer" autoplay="" class="motion-media" data-managed-video="" data-motion-key="slicing" data-poster="images/slicing.poster.webp" height="720" loop="" muted="" playsinline="" preload="none" width="1280"><source data-src="images/slicing.loop.webm" type="video/webm"/><source data-src="images/slicing.loop.mp4" type="video/mp4"/></video><figcaption>The controlled slice transforms an invisible geological structure into a readable on-site interaction.</figcaption></figure></article></div></div><div class="case-study-subsection"><h4>Design Decisions</h4><div class="case-study-card-grid"><article><h5>Image Tracking Instead of GPS</h5><p>A local target gives repeatable offline alignment.</p></article><article><h5>Guided On-Site Interaction</h5><p>A tutorial and questions keep the visit clear.</p></article><article><h5>One Readable Rock Face</h5><p>Testing replaced two walls with one cross-section.</p></article><article><h5>Indoor Simulation for Iteration</h5><p>A scan enabled testing between visits.</p></article></div></div><div class="case-study-subsection"><h4>Technical Implementation</h4><div class="case-study-card-grid"><article><h5>Tracking &amp; Anchoring</h5><p>Vuforia recognises and anchors the target.</p></article><article><h5>Geological Slice</h5><p>A URP shader exposes the barite interior.</p></article><article><h5>Experience State Flow</h5><p>Unity manages questions, progress and UI.</p></article><article><h5>Indoor Testing</h5><p>A 3D scan supports placement checks.</p></article><article><h5>Mobile Pipeline</h5><p>The final build targets Android.</p></article></div></div></section>
<section class="case-study-section"><h3>Result</h3><p>Replacing GPS with a local image target and using indoor simulation made the on-site Augmented Reality experience more dependable without losing its connection to the gorge.</p><p>A guided sequence presents the geological subject within a short visitor experience.</p></section>
...
<figure class="popup-media popup-media--hero"><div class="video-container"><iframe allow="autoplay; encrypted-media; picture-in-picture; web-share" allowfullscreen="" loading="lazy" src="https://www.youtube-nocookie.com/embed/5-wy2LQBra0?autoplay=1&amp;mute=1&amp;loop=1&amp;playlist=5-wy2LQBra0&amp;controls=0&amp;playsinline=1" title="ARVI project trailer"></iframe></div><figcaption>ARVI project trailer.</figcaption></figure>
<section class="case-study-section"><h3>Context</h3><p>The Augmented and Virtual Reality Design programme saw an opportunity to make that introduction conversational, spatial and available beyond a single open day.</p><p>ARVI was designed as a long-term mixed reality companion that welcomes visitors, supports students and represents the programme inside its own laboratory.</p><p>A consistent personality, modular knowledge base and locally deployed language model keep those conversations maintainable, private and independent from commercial cloud services.</p><div class="case-study-goal"><p class="case-study-section-label">Context</p><p class="case-study-goal-text">The project was developed for students in the B.A. Augmented and Virtual Reality Design programme at Darmstadt University of Applied Sciences, based at Media Campus Dieburg. Its dedicated Mixed Reality laboratory supports XR teaching, demonstrations and prototyping. Visitors wear a Meta Quest headset and meet ARVI as a shared spatial companion rather than interacting with a traditional chatbot.</p></div><figure class="popup-media popup-media--narrow"><img alt="ARVI project poster explaining the companion, its audience and project goals" decoding="async" height="1440" loading="lazy" src="images/arvi poster.optimized.webp" width="1080"/><figcaption>Project poster presented during the public exhibition at the Media Campus Dieburg.</figcaption></figure></section>
<section class="case-study-section"><h3>Problem</h3><p>A study programme can be difficult to understand through a webpage or a brief laboratory tour, especially when new students and visitors arrive with very different questions.</p></section>
<section class="case-study-section"><h3>Contribution</h3><div class="contribution-grid"><article><h4>Designed</h4><p>Knowledge architecture, behavioural dataset structure and modular content separation.</p></article><article><h4>Generated</h4><p>Fine-tuning conversations using a dedicated CustomGPT workflow constrained for structured JSONL output.</p></article><article><h4>Fine-tuned</h4><p>Implemented the LoRA adaptation workflow for the Qwen 2.5 model.</p></article><article><h4>Merged &amp; Deployed</h4><p>Merged the trained adapter, generated the GGUF runtime model and validated local inference with llama.cpp.</p></article><article><h4>Documented</h4><p>Created the training workflow, deployment pipeline and technical documentation for future development.</p></article></div><div class="collaboration-credits case-study-subsection"><h4>Collaboration &amp; Credits</h4><div class="credit-list"><p class="credit-list__item">Karam Alsawaftah · Jacopo Perilli · Antonela Matanović · Riccardo Liguori · Mirabella Hohenlohe Langenburg · Ivan Fesenko</p></div></div></section>
<section class="case-study-section"><h3>Implementation</h3><div class="case-study-subsection"><h4>User Journey</h4><div class="experience-journey experience-journey--compact"><article class="experience-stage"><p class="experience-stage-number">01</p><h5>Meet ARVI</h5><p>The visitor puts on a Meta Quest headset and meets a floating mixed reality assistant sharing the physical laboratory.</p><figure class="popup-media"><img alt="Prof. Dr. Frank Gabler wearing a Meta Quest headset while testing ARVI" decoding="async" height="1080" loading="lazy" src="images/arvi user testing.optimized.webp" width="1920"/><figcaption>Prof. Dr. Frank Gabler meets ARVI during the final user evaluation session.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">02</p><h5>Ask Questions</h5><p>The visitor speaks naturally instead of navigating menus or learning commands.</p><figure class="popup-media"><video aria-label="Visitor entering the mixed reality experience and approaching ARVI" autoplay="" class="motion-media" data-managed-video="" data-motion-key="user arriving" data-poster="images/user arriving.poster.webp" height="450" loop="" muted="" playsinline="" preload="none" width="800"><source data-src="images/user arriving.loop.webm" type="video/webm"/><source data-src="images/user arriving.loop.mp4" type="video/mp4"/></video><figcaption>The visitor enters the shared mixed reality space before beginning a natural conversation.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">03</p><h5>Receive Contextual Answers</h5><p>ARVI responds with a consistent personality and adapts its explanations to students, visitors and project-related questions.</p><figure class="popup-media"><video aria-label="Visitor asking ARVI questions and receiving contextual answers" autoplay="" class="motion-media" data-managed-video="" data-motion-key="ask questions" data-poster="images/ask questions.poster.webp" height="450" loop="" muted="" playsinline="" preload="none" width="800"><source data-src="images/ask questions.loop.webm" type="video/webm"/><source data-src="images/ask questions.loop.mp4" type="video/mp4"/></video><figcaption>Responses combine programme knowledge with ARVI’s consistent conversational personality.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">04</p><h5>Explore the Programme</h5><p>Students and visitors learn about the study programme, laboratories, professors and ongoing work through conversation.</p><figure class="popup-media"><video aria-label="Visitor exploring information about the Augmented and Virtual Reality Design programme through ARVI" autoplay="" class="motion-media" data-managed-video="" data-motion-key="user asking questions 2" data-poster="images/user asking questions 2.poster.webp" height="450" loop="" muted="" playsinline="" preload="none" width="800"><source data-src="images/user asking questions 2.loop.webm" type="video/webm"/><source data-src="images/user asking questions 2.loop.mp4" type="video/mp4"/></video><figcaption>The same conversational interface supports broader exploration of the programme and its facilities.</figcaption></figure></article></div></div><div class="case-study-subsection"><h4>Design Decisions</h4><div class="case-study-card-grid"><article><h5>Long-lasting AI Personality</h5><p>ARVI was designed as a permanent member of the study programme rather than a prototype for a single semester.</p></article><article><h5>Behaviour over Memorisation</h5><p>Knowledge comes from retrieval while personality and coaching behaviour are learned through fine-tuning.</p></article><article><h5>Local-first Architecture</h5><p>Local operation keeps the experience independent, privacy-friendly and deployable inside the university.</p></article><article><h5>Knowledge Separation</h5><p>Knowledge, prompts and behavioural training remain independent for easier maintenance.</p></article><article><h5>Mixed Reality Presence</h5><p>Meeting a floating companion inside the laboratory creates a stronger programme identity than opening a chatbot in a browser.</p></article><article><h5>Embodied Interaction</h5><p>Instead of interacting with another browser chatbot, visitors meet ARVI as a spatial companion sharing the same physical environment. The mixed reality format turns the assistant into a social presence rather than another application window.</p></article></div></div><div class="case-study-subsection"><h4>Challenges</h4><div class="case-study-card-grid"><article><h5>Behaviour and Knowledge</h5><p>Separating personality and coaching behaviour from factual information.</p></article><article><h5>Personality Consistency</h5><p>Keeping ARVI recognisable across hundreds of conversations.</p></article><article><h5>Reusable Knowledge</h5><p>Keeping updateable information out of behavioural training.</p></article><article><h5>Efficient Training</h5><p>Reducing GPU requirements through LoRA fine-tuning.</p></article><article><h5>Local Deployment</h5><p>Preparing the final model for a dependable on-site runtime.</p></article></div></div></section>
<section class="case-study-section"><h3>Result</h3><div class="case-study-card-grid"><article><h4>Local Mixed Reality Companion</h4><p>Successfully deployed a local mixed reality AI companion.</p></article><article><h4>Reusable Pipeline</h4><p>Created a reusable behavioural fine-tuning workflow.</p></article><article><h4>Maintainable Architecture</h4><p>Developed a modular knowledge architecture for future updates.</p></article><article><h4>Public Demonstration</h4><p>Presented and demonstrated ARVI during the final public exhibition.</p></article><article><h4>Live Evaluation</h4><p>Evaluated the experience through user testing with students and professors.</p></article></div></section>
...
<figure class="popup-media popup-media--hero"><img alt="Visitors using Animal Garden" class="project-hero-image" decoding="async" height="1280" loading="lazy" src="images/visitor 1.optimized.webp" width="1920"/><figcaption>Visitors create, scan and discover an animal in the shared garden.</figcaption></figure>
<section class="case-study-section"><h3>Context</h3><p>A hands-on drawing activity created an opportunity to connect familiar paper-based play with a shared digital environment.</p><p><strong>Animal Garden</strong> invites visitors to colour a Bosch-inspired creature, scan it and watch it join an animated projected garden. The scanner and real-time application transform each individual drawing into a collective public installation.</p></section>
<section class="case-study-section"><h3>Problem</h3><p>Exhibitions often ask children to observe an artwork without giving them a way to become part of it.</p><div class="case-study-goal"><p class="case-study-section-label">Project Goal</p><p class="case-study-goal-text">Transform hand-coloured drawings into animated creatures through an accessible physical-digital exhibition experience.</p></div></section>
<section class="case-study-section"><h3>Contribution</h3><div class="contribution-grid"><article><h4>Unity Development</h4><p>Built spawning, movement, states and recycling.</p></article><article><h4>Character Production</h4><p>Prepared, rigged and initially animated five creatures.</p></article><article><h4>Environment Production</h4><p>Prepared assets and composed the scene.</p></article><article><h4>Scanner &amp; Hardware Integration</h4><p>Helped design, build and integrate the station.</p></article><article><h4>Exhibition Deployment</h4><p>Supported installation, calibration and visitors.</p></article><article><h4>Planning &amp; Documentation</h4><p>Created workflows, milestones and handover guidance.</p></article></div><div class="collaboration-credits case-study-subsection"><h4>Collaboration &amp; Credits</h4><div class="credit-list"><p class="credit-list__item">Antonela Matanović · Riccardo Liguori · Linus Steffens · Michael Gödde</p></div></div></section>
<section class="case-study-section"><h3>Implementation</h3><div class="case-study-subsection"><h4>User Journey</h4><div class="experience-journey experience-journey--compact"><article class="experience-stage"><p class="experience-stage-number">01</p><h5>Colour</h5><p>Choose and colour a creature.</p><figure class="popup-media"><img alt="Visitor colouring a print sheet" decoding="async" height="1280" loading="lazy" src="images/visitor coloring the print sheet.optimized.webp" width="1920"/><figcaption>Paper makes participation familiar and accessible.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">02</p><h5>Scan</h5><p>Insert the sheet into the station.</p><figure class="popup-media"><img alt="Visitor placing the marked print sheet into the scanner" decoding="async" height="720" loading="lazy" src="images/place the marker.optimized.webp" width="1036"/><figcaption>The station creates a clear physical-digital handoff.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">03</p><h5>Process</h5><p>Camera input and markers align the drawing.</p><figure class="popup-media popup-media--narrow"><img alt="Animal Garden print sheet with alignment markers surrounding the drawing area" decoding="async" height="3508" loading="lazy" src="images/print_sheet.png" width="2480"/><figcaption>The printed markers give the camera a reliable reference for aligning the visitor’s drawing.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">04</p><h5>Animate</h5><p>Unity maps it onto a rigged creature.</p></article><article class="experience-stage"><p class="experience-stage-number">05</p><h5>Enter the Garden</h5><p>The animal joins the projection.</p><figure class="popup-media"><img alt="Visitors watching Animal Garden" decoding="async" height="1280" loading="lazy" src="images/visitors sitting.optimized.webp" width="1920"/><figcaption>Individual drawings become a collective scene.</figcaption></figure></article></div></div><div class="case-study-subsection"><h4>Design Decisions</h4><div class="case-study-card-grid"><article><h5>Scanner Over Touchscreen</h5><p>Paper colouring is tactile and visible.</p></article><article><h5>Preserve the Visitor’s Drawing</h5><p>Clear silhouettes keep marks recognisable.</p></article><article><h5>Shared Projection</h5><p>The large garden makes participation social.</p></article><article><h5>Continuous Exhibition Operation</h5><p>Animal recycling supports stable use.</p></article></div></div><div class="case-study-subsection"><h4>Technical Implementation</h4><div class="case-study-card-grid"><article><h5>Capture &amp; Mapping</h5><p>OpenCV and markers align dynamic textures.</p></article><article><h5>Character Pipeline</h5><p>Photoshop and Unity 2D rigs preserve artwork.</p></article><article><h5>Movement &amp; Instance Management</h5><p>Splines, waypoints, states and recycling control creatures.</p></article><article><h5>Environment</h5><p>Layered parallax assets create projection depth.</p></article><article><h5>Hardware &amp; Exhibition Integration</h5><p>Scanner, camera, PC and projection work as one system.</p></article></div></div><div class="case-study-subsection"><h4>Process &amp; Gallery</h4><h5>Character Production</h5><div class="popup-gallery popup-gallery--two"><figure><img alt="Animal cleanup" decoding="async" height="647" loading="lazy" src="images/cropping animals.optimized.webp" width="1152"/><figcaption>Source creatures were isolated for animation.</figcaption></figure><figure><img alt="Unity sprite rig" decoding="async" height="611" loading="lazy" src="images/animating animals.optimized.webp" width="1153"/><figcaption>2D rigs retain scanned textures in motion.</figcaption></figure><figure><img alt="Environment cleanup" decoding="async" height="515" loading="lazy" src="images/before and after cleanup.optimized.webp" width="1381"/><figcaption>Cleanup prepared the painting for layering.</figcaption></figure><figure><img alt="Completed scene" decoding="async" height="962" loading="lazy" src="images/finished scene.optimized.webp" width="1303"/><figcaption>The scene combines visitor textures and animated layers.</figcaption></figure></div><h5>Scanner Build</h5><div class="popup-gallery popup-gallery--two"><figure><img alt="Scanner prototype" decoding="async" height="1920" loading="lazy" src="images/prototype.optimized.webp" width="1440"/><figcaption>The prototype validated scale and placement.</figcaption></figure><figure><img alt="Scanner frame" decoding="async" height="1920" loading="lazy" src="images/building progress (2).optimized.webp" width="1440"/><figcaption>The frame established camera distance.</figcaption></figure><figure><img alt="Scanner enclosure" decoding="async" height="1920" loading="lazy" src="images/building progress (4).optimized.webp" width="1440"/><figcaption>Matte panels completed the exhibition object.</figcaption></figure></div><h5>Exhibition Testing</h5><div class="popup-gallery popup-gallery--two"><figure><img alt="Projection test" decoding="async" height="1920" loading="lazy" src="images/testing the projection.optimized.webp" width="1440"/><figcaption>Tests calibrated scale and framing.</figcaption></figure><figure><img alt="Installed station" decoding="async" height="1920" loading="lazy" src="images/exhibit place (1).optimized.webp" width="1440"/><figcaption>The final installation aligned the scanner, drawing table and shared projection for public use.</figcaption></figure></div></div></section>
<section class="case-study-section"><h3>Result</h3><p>The Unity application, scanner, camera and projection operated together as a public installation in the exhibition space.</p><p>Simulation, calibration and handover documentation supported dependable day-to-day operation.</p></section>
...
<figure class="popup-media popup-media--hero"><div class="video-container"><iframe allow="autoplay; encrypted-media; picture-in-picture; web-share" allowfullscreen="" loading="lazy" src="https://www.youtube.com/embed/hUOfJCqo2rE?autoplay=1&amp;mute=1&amp;loop=1&amp;playlist=hUOfJCqo2rE&amp;controls=0&amp;playsinline=1" title="Insect's Delegate: Brumble's Journey trailer"></iframe></div><figcaption>Brumble guides the player through urban biodiversity and pollination.</figcaption></figure>
<section class="case-study-section"><h3>Context</h3><p>Virtual reality offered an opportunity to turn ecological ideas into actions rather than explanations.</p><p><strong>Insect’s Delegate: Brumble’s Journey</strong> shrinks the player into a miniature city ecosystem, where exploration, guided flight and pollination make learning part of the story. The project was inspired by Senckenberg Naturmuseum Frankfurt’s <em>City Insects</em> exhibition.</p></section>
<section class="case-study-section"><h3>Problem</h3><p>Young audiences often know that bees matter, but rarely experience how scale, perception and habitat shape an insect’s world.</p><div class="case-study-goal"><p class="case-study-section-label">Project Goal</p><p class="case-study-goal-text">Teach young audiences about urban pollinators through embodied interaction, playful scale changes and a clear narrative journey.</p></div></section>
<section class="case-study-section"><h3>Contribution</h3><div class="contribution-grid"><article><h4>Experience Design</h4><p>Shaped research, personas, story and journey.</p></article><article><h4>XR Development</h4><p>Built interaction, mounted movement and scene logic.</p></article><article><h4>Environment &amp; Visual Development</h4><p>Blocked the park, modelled props and explored shaders.</p></article><article><h4>Testing &amp; Iteration</h4><p>Refined navigation, comfort and clarity.</p></article><article><h4>Production Coordination</h4><p>Set up Jira and supported milestones and documentation.</p></article></div><div class="collaboration-credits case-study-subsection"><h4>Collaboration &amp; Credits</h4><div class="credit-list"><p class="credit-list__item">Jacopo Perilli · Lara Heß · Mutlu Yakubov · Antonela Matanović · Himanshu Dahiya</p></div></div></section>
<section class="case-study-section"><h3>Implementation</h3><div class="case-study-subsection"><h4>User Journey</h4><div class="experience-journey"><article class="experience-stage"><p class="experience-stage-number">01</p><h5>Discover the City Park</h5><p>Explore and place insect hotels.</p><div class="popup-gallery popup-gallery--two"><figure><img alt="City park" decoding="async" height="823" loading="lazy" src="images/city.optimized.webp" width="1463"/><figcaption>The park establishes human scale.</figcaption></figure><figure><img alt="Insect hotel task" decoding="async" height="1080" loading="lazy" src="images/insect hotel.optimized.webp" width="1920"/><figcaption>Conservation becomes a direct task.</figcaption></figure></div></article><article class="experience-stage"><p class="experience-stage-number">02</p><h5>Enter the Miniature World</h5><p>A butterfly shrinks the player.</p><figure class="popup-media"><img alt="Miniature environment" decoding="async" height="833" loading="lazy" src="images/environment.optimized.webp" width="1481"/><figcaption>Dense foliage makes the scale change legible.</figcaption></figure></article><article class="experience-stage"><p class="experience-stage-number">03</p><h5>Meet and Ride Brumble</h5><p>Follow the bee through the landscape.</p><div class="popup-gallery popup-gallery--two"><figure><img alt="Brumble" decoding="async" height="829" loading="lazy" src="images/brumble.optimized.webp" width="1474"/><figcaption>Brumble anchors the narrative.</figcaption></figure><figure><img alt="Riding Brumble" decoding="async" height="1080" loading="lazy" src="images/riding brumble.optimized.webp" width="1920"/><figcaption>Guided flight introduces the world comfortably.</figcaption></figure></div></article><article class="experience-stage"><p class="experience-stage-number">04</p><h5>Climb the Tree</h5><p>Dismount and navigate directly.</p><div class="popup-gallery popup-gallery--two"><figure><img alt="Tree climbing" decoding="async" height="1080" loading="lazy" src="images/climbing the tree.optimized.webp" width="1920"/><figcaption>Climbing returns direct control.</figcaption></figure><figure><img alt="Tree route" decoding="async" height="1080" loading="lazy" src="images/tree ladder.optimized.webp" width="1920"/><figcaption>The route guides movement upward.</figcaption></figure></div></article><article class="experience-stage"><p class="experience-stage-number">05</p><h5>Use Bee Vision and Pollinate</h5><p>Identify flower patterns and pollinate.</p><div class="popup-gallery popup-gallery--two"><figure><img alt="Flower field" decoding="async" height="832" loading="lazy" src="images/flowers.optimized.webp" width="1479"/><figcaption>The field establishes the task space.</figcaption></figure><figure><img alt="Bee vision" decoding="async" height="1080" loading="lazy" src="images/pollination.optimized.webp" width="1920"/><figcaption>Feedback connects perception with pollination.</figcaption></figure></div></article><article class="experience-stage"><p class="experience-stage-number">06</p><h5>Return to Human Scale</h5><p>The butterfly restores the player and closes the story.</p></article></div></div><div class="case-study-subsection"><h4>Design Decisions</h4><div class="case-study-card-grid"><article><h5>Learning Through Action</h5><p>Ideas are embedded in physical tasks.</p></article><article><h5>Brumble as a Guide</h5><p>A friendly character structures the journey.</p></article><article><h5>Scale as Storytelling</h5><p>Insect scale makes the ecosystem tangible.</p></article><article><h5>Guided and Direct Movement</h5><p>Flight and hands-on tasks balance comfort and agency.</p></article></div></div><div class="case-study-subsection"><h4>Technical Implementation</h4><div class="case-study-card-grid"><article><h5>XR Interaction</h5><p>Toolkit systems support locomotion, hands and interaction.</p></article><article><h5>Mounted Movement</h5><p>Mounting and follow logic synchronise the player.</p></article><article><h5>Experience Flow</h5><p>States connect shrinking, flight, climbing and pollination.</p></article><article><h5>Navigation &amp; Testing</h5><p>NavMesh debugging and prototypes refined comfort.</p></article><article><h5>Visual Development</h5><p>Blender props and shaders support scale changes.</p></article></div></div></section>
<section class="case-study-section"><h3>Result</h3><p>The completed Virtual Reality experience embeds ecological ideas in exploration, guided flight and pollination tasks.</p><p>User testing informed more comfortable transitions between human scale, mounted movement and climbing.</p></section>
